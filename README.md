...
- Select text on a webpage and open the extension to see the selected text in the input field.
- Choose a tone from the available options: "Formal," "Casual," or "Friendly."
- The extension uses OpenAI's GPT3.5 model to analyze the tone and generate a rephrased version of the text in the selected tone.
- The user can reset the text input to clear the selected text.
- The user can save the rephrased text to the clipboard for easy copying and pasting.
